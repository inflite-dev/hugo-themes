+++
# Provenance-includes-location: https://github.com/rust-lang/book/blob/main/src/ch01-02-hello-world.md
# Provenance-includes-license: Apache-2.0
# Provenance-includes-copyright: The Rust Project Developers.
 
title = "Hello World in Rust"
description = "Chapter 1, Section 2 of the Rust Book"
...
**Note: this document is a redistribution of an original work,
for demonstration of Markdown rendering and styling only.**

**Please see the `Provenance-includes` file headers for this document in the [repo](https://github.com/inflite-dev/hugo-themes)
for references to the original work, license, and copyright.**
...
we suggest making a _projects_ directory in your home directory and keeping allp
your projects there.
